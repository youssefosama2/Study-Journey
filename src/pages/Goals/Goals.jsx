...
const THIRD_SECONDARY_EXAM_START_DATE = "2027-06-26";

/* =========================================================
   Grade Helpers
========================================================= */

const getGradeInfo = (gradeLevel) => {
  switch (gradeLevel) {
    case "first_secondary":
      return {
        label: "أولى ثانوي",
        goalTitle: "الحصول على 95% في أولى ثانوي",
        goalDescription: "هدفي الأساسي لهذا العام الدراسي",
        examDate: null,
        examDateLabel: "سيتم تحديد موعد الامتحانات",
      };

    case "second_secondary":
      return {
        label: "تانية ثانوي",
        goalTitle: "الحصول على 95% في تانية ثانوي",
        goalDescription: "هدفي الأساسي لهذا العام الدراسي",
        examDate: null,
        examDateLabel: "سيتم تحديد موعد الامتحانات",
      };
    ...
    default:
      return {
        label: "تالتة ثانوي",
        goalTitle: "الحصول على 95% في الثانوية العامة",
        goalDescription: "هدفي الأساسي لهذا العام الدراسي",
        examDate: THIRD_SECONDARY_EXAM_START_DATE,
        examDateLabel: "26 يونيو 2027",
      };
  }
};
...
const getSubjectMessage = (percentage) => {
  if (percentage >= 90) {
    return "ممتاز جدًا، حافظ على مستواك";
  }

  if (percentage >= 80) {
    return "مستوى جيد جدًا";
  }

  if (percentage >= 70) {
    return "جيد، ويمكن رفع المستوى";
  }
...
const Goals = () => {
  ...
  const [gradeLevel, setGradeLevel] = useState("third_secondary");
  ...
  const gradeInfo = useMemo(() => {
    return getGradeInfo(gradeLevel);
  }, [gradeLevel]);
  ...
  const fetchGoalsData = useCallback(
    async (showRefresh = false) => {
      try {
        ...
        // =====================================================
        // FETCH SUBJECTS ACCORDING TO STUDENT CURRICULUM
        // =====================================================
        ...
        if (
          currentGrade === "first_secondary" ||
          currentGrade === "second_secondary"
        ) {
          if (!educationSystem) {
            throw new Error(
        ...
        /*
          ممكن يكون عندنا أكثر من نتيجة لنفس الدرس.
          ...
          لذلك نستخدم curriculum_lesson_id أولًا
          ثم lesson_id كـ fallback.
        */
        ...
        (
          ...
          const resultKey =
            item.curriculum_lesson_id ||
            item.lesson_id ||
            item.id;

          if (
            !latestResultsMap.has(
              resultKey
            )
          ) {
            latestResultsMap.set(
              resultKey,
              item
            );
          }
  ...
  const openCreateModal = () => {
    setFormData({
      title: gradeInfo.goalTitle,
      target: 95,
      description:
        gradeInfo.goalDescription,
    });
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      Swal.fire({
        ...
        icon: "warning",
        title:
          "أدخل هدفًا صحيحًا من 1 إلى 100",
    ...
    try {
      ...
      /*
        تالتة ثانوي فقط لها موعد امتحانات
        محدد حاليًا.
      */
      ...
      if (goal?.id) {
        const {
          ...
          .update({
            ...
            description:
              goalPayload.description,

            due_date:
              goalPayload.due_date,

            target_value:
              goalPayload.target_value,

            current_value:
              goalPayload.current_value,

            is_completed:
              goalPayload.is_completed,

            completed_at:
              goalPayload.completed_at,

            updated_at:
              goalPayload.updated_at,
          })
          .eq("id", goal.id)
          .eq(
            "user_id",
    ...
    return (
      ...
      >
        ...
        <div className="page-loading">
          ...
          <p>
            بنحمّل أهدافك وتقدمك والبيانات
            الخاصة بخطتك.
          </p>
        </div>
      </main>
        ...
        <main className="goals-container">
          ...
          <section className="goals-hero">
            <div className="hero-content">
              ...
              <p>
                حدد النسبة التي تريد الوصول
                إليها، وسنحسب تقدمك تلقائيًا
                من نتائج امتحاناتك.
              </p>
            </div>
          </section>
          ...
          <section className="empty-goal-card">
            ...
            <h2>
              ليس لديك هدف سنوي حتى الآن
            </h2>

            <p>
              أنشئ هدفك الدراسي وحدد النسبة
              التي تريد الوصول إليها خلال
              العام الدراسي.
            </p>
      ...
      <main className="goals-container">
        ...
        <section className="goals-hero">
          <div className="hero-content">
            ...
            <p>
              تابع مستواك الحقيقي واعرف
              بالضبط أين تحتاج إلى بذل
              المزيد من الجهد.
            </p>
          </div>
        ...
        <section className="info-grid">
          <div className="info-card exam-date-card">
            ...
            <div className="info-card-content">
              ...
              <p>
                {gradeInfo.examDate
                  ? "التاريخ ثابت ولا يحتاج إلى إدخال"
                  : "موعد الامتحانات سيتم تحديده لاحقًا"}
              </p>
            </div>
          </div>
        ...
        <section className="section-block">
          <div className="section-heading">
            <div>
              ...
              <p>
                نحدد المواد التي تحتاج
                إلى اهتمام أكبر بناءً
                على نتائجك.
              </p>
            </div>
          ...
          {!subjectAnalysis.length ? (
            <div className="no-data-card">
              ...
              <p>
                سجل نتائج بعض الامتحانات
                حتى نتمكن من تحليل مستواك
                في كل مادة.
              </p>
            </div>
          ) : (
            ...
            <div className="plan-details">
              <div className="plan-detail-box">
                ...
                <div>
                  ...
                  <p>
                    المواد ذات النسب الأقل
                    هي الأولوية الأولى في
                    جدولك.
                  </p>
                </div>
              </div>
        ...
        <section className="motivation-card">
          ...
          <div>
            ...
            <p>
              استمر في المذاكرة، راقب
              نتائجك، وتعلم من أخطائك.
            </p>
          </div>
        </section>
      </main>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <small>
              {gradeInfo?.examDate
                ? "موعد الامتحانات ثابت ولا يمكن تعديله من الطالب."
                : "موعد الامتحانات سيتم تحديده لاحقًا."}
            </small>
          </div>
          {/* Automatic Progress */}
