...
export default function Home() {
  ...
  const loadHomeData = useCallback(
    async (showRefresh = false) => {
      ...
      try {
        ...
        //
        // تالتة:
        // subject_sections القديم
        // ====================

        let loadedSubjects = [];

        const gradeLevel = profileData?.grade_level || null;
        ...
        if (isNewCurriculum) {
          ...
          if (educationSystem === "general") {
            ...
            // أولى بكالوريا = سنة تمهيدية => track null
            if (gradeLevel === "first_secondary" || !track) {
              accessQuery = accessQuery.is("track", null);
            } else {
              accessQuery = accessQuery.eq("track", track);
            }
          }
          ...
          if (accessError) {
            console.warn(
              "Subject curriculum access warning:",
              accessError.message
            );
          }
          ...
          if (subjectIds.length > 0) {
            ...
            if (subjectsError) {
              console.warn(
                "New curriculum subjects warning:",
                subjectsError.message
              );
            }

            loadedSubjects = subjectsData || [];
          }
        }
  ...
  const todayStudyMinutes = useMemo(() => {
    return studies
      .filter(
        (study) =>
          getDateKey(study.studied_at) === today
      )
      .reduce(
        (sum, study) =>
  ...
  const weeklyTaskStats = useMemo(() => {
    const weekTasks = tasks.filter((task) => {
      const dateValue =
        task.plan_date || task.created_at;
  ...
  const upcomingReviews = useMemo(() => {
    const standardReviews = reviews.map(
      (review) => ({
        ...review,
  ...
  const subjectStats = useMemo(() => {
    ...
    // المواد التي تم تحديدها للطالب فقط
    ...
    studies.forEach((study) => {
      ...
      // مهم:
      // لا نضيف مادة مش موجودة ضمن مواد الطالب
      ...
      item.studyMinutes += Number(
        study.study_minutes || 0
      );
      ...
      <main className="home-container">
          ...
          <article className="home-card today-tasks-card">
            ...
            {todayTasks.length > 0 ? (
              ...
              <div className="home-empty">
                ...
                <h3>
                  اليوم فاضي من المهام 🎉
                </h3>

                <p>
                  ممكن تستغل الوقت في المراجعة أو جلسة تركيز.
                </p>
            ...
            {latestFocusSession && (
              <div className="last-focus">
                ...
                <div>
                  ...
                  <span>
                    {formatDuration(
                      latestFocusSession.actual_seconds
                    )}
                  </span>
                </div>
              </div>
          ...
          <article className="home-card reviews-card">
            ...
            0 ? (
              ...
              <div className="home-empty compact">
                ...
                <h3>
                  لا توجد مراجعات قريبة
                </h3>

                <p>
                  أنت متابع جدول المراجعة بشكل ممتاز.
                </p>
              </div>
            )}
          ...
          <article className="home-card goals-card">
            ...
            {activeGoals.length > 0 ? (
              ...
              <div className="home-empty compact">
                ...
                <p>
                  حدد هدف واضح وابدأ تبني تقدمك عليه.
                </p>
        ...
        <section className="home-card subjects-card">
          ...
          {subjectStats.length > 0 ? (
            ...
            <div className="home-empty">
              ...
              <h3>
                ابدأ مذاكرة أول مادة
              </h3>

              <p>
                بمجرد تسجيل جلسات المذاكرة هنقدر نعرض تقدمك هنا.
              </p>
          ...
          <article className="home-card achievements-card">
            ...
            {lastAchievement ? (
              ...
              <div className="achievement-empty">
                ...
                <span>
                  أول إنجاز ليك قريب، استمر في التقدم!
                </span>
              </div>
            )}
        ...
        <section className="home-final-cta">
          ...
          <div>
            ...
            <p>
              مش لازم تعمل كل حاجة مرة واحدة. ابدأ بخطوة صغيرة النهارده.
            </p>
          </div>
